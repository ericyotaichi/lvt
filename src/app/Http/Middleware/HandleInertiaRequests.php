            ...
            'translations' => fn () => [
                ...
                'admin' => [
                    'articles' => [
                        ...
                        'create_bundle' => __('common.admin.articles.create_bundle'),
                        ...
                        'slug' => __('common.admin.articles.slug'),
                        'product' => __('common.admin.articles.product'),
                        'application' => __('common.admin.articles.application'),
                        'case' => __('common.admin.articles.case'),
                    ...
                    'form' => [
                        ...
                        'slug' => __('common.admin.form.slug'),
                        'slug_placeholder' => __('common.admin.form.slug_placeholder'),
